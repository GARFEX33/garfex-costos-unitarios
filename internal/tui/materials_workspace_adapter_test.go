...
func TestMaterialsWorkspaceAdapterRespondNonTextInputsNeverFabricateOrSearch(t *testing.T) {
	...
	adapter := NewMaterialsWorkspaceAdapter(fake, getter, &fakeMaterialDescriber{}, &fakeMaterialCreator{}, &fakeMaterialUpdater{})
...
func TestMaterialsWorkspaceAdapterAcceptsMaterialSearcherAndGetter(t *testing.T) {
	...
	adapter := NewMaterialsWorkspaceAdapter(searcher, getter, &fakeMaterialDescriber{}, &fakeMaterialCreator{}, &fakeMaterialUpdater{})
	if adapter == nil {
...
func TestMaterialsWorkspaceAdapterRespondSelectResultOpensDetail(t *testing.T) {
	...
	adapter := NewMaterialsWorkspaceAdapter(&fakeMaterialSearcher{}, getter, &fakeMaterialDescriber{}, &fakeMaterialCreator{}, &fakeMaterialUpdater{})
...
func TestMaterialsWorkspaceAdapterRespondBackReRunsSameSearch(t *testing.T) {
	...
	fake := &fakeMaterialSearcher{results: materials}
	adapter := NewMaterialsWorkspaceAdapter(fake, &fakeMaterialGetter{material: materials[0]}, &fakeMaterialDescriber{}, &fakeMaterialCreator{}, &fakeMaterialUpdater{})
...
func TestMaterialsWorkspaceAdapterRespondDetailUsesDescriberForTitle(t *testing.T) {
	...
	getter := &fakeMaterialGetter{material: material}
	adapter := NewMaterialsWorkspaceAdapter(&fakeMaterialSearcher{}, getter, &fakeMaterialDescriber{text: "Cable THHN 12 AWG BLANCO"}, &fakeMaterialCreator{}, &fakeMaterialUpdater{})
